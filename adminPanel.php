...
<body>
    ...
    <h1 class="text-white text-center font-weight-bold bg-success" style="font-size: 55px;"> Admin Panel </h1>
    <ul class="list-group">
    ...
    <br>
        <form method="post" class="bg-light">
            <center><input type="submit" value="Logout" name="submit" class="btn btn-success"></center>
        </form>
    </div>
    <br>
