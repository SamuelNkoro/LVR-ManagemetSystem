<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        {
            $sql = "insert into vehicle(tempNo, name, aadhar, chassisNo, engineNo, vehicleClass, color, fuelType, seatingType, district) 
            values('$tempNo', '$name', '$aadhar', '$chassisNo', '$engineNo', '$vehicleClass', '$color', '$fuelType', '$seatingType', '$district')";
            $res = $db -> query($sql);
            if ($res)
            {
                $db -> close();
...
<body>
    ...
    <br>
    <h1 class="text-white text-center font-weight-bold bg-success" style="font-size: 55px;"> New Vehicle Registration </h1>
    ...
    <script type="text/javascript">
        function validation() {
            ...
            if (district == "") {
                document.getElementById('districterr').innerHTML =" ** Please fill the rto field";
                return false;
            }
            else 
            {
